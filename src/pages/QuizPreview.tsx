  ...
  const sessions = quiz.sessions.length > 0 ? quiz.sessions : [
    {
      ...
      showAd: false,
      required: true,
      adDisplayTime: 5, // Adicionado para mock
    },
    {
      id: 'mock_q2',
      type: 'question' as const,
    ...
    if (showAd) {
      ...
      return (
        <AdManager
          ...
          adDisplayTime={currentSessionData?.adDisplayTime ?? 5} // Passar o tempo de exibição do anúncio da sessão
        />
      );
    }
    ...
    if (showFinalAd) {
      return (
        <AdManager
          ...
          adDisplayTime={quiz.settings.adDisplayTime ?? 5} // Passar o tempo de exibição do anúncio final
        />
      );
    }
